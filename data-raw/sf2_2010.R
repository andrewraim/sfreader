...
sf2_2010_geo_cols = tribble(
     ~ID,     ~FIELD, ~START_POS, ~FIELD_SIZE, ~DATA_TYPE, ~DESCRIPTION,
      3L,   "FILEID",         1L,          6L,      "A/N",  "File Identification",
      4L,   "STUSAB",         7L,          2L,        "A",  "State/US-Abbreviation (USPS)",
      5L,   "SUMLEV",         9L,          3L,      "A/N",  "Summary Level",
      6L,  "GEOCOMP",        12L,          2L,      "A/N",  "Geographic Component",
      7L, "CHARITER",        14L,          3L,      "A/N",  "Characteristic Iteration",
      8L,    "CIFSN",        17L,          2L,      "A/N",  "Characteristic Iteration File Sequence Number",
      9L, "LOGRECNO",        19L,          7L,        "N",  "Logical Record Number",
     10L,   "REGION",        26L,          1L,      "A/N",  "Region",
     11L, "DIVISION",        27L,          1L,      "A/N",  "Division",
     12L,    "STATE",        28L,          2L,      "A/N",  "State (FIPS)",
     13L,   "COUNTY",        30L,          3L,      "A/N",  "County",
     14L, "COUNTYCC",        33L,          2L,      "A/N",  "FIPS County Class Code",
     15L, "COUNTYSC",        35L,          2L,      "A/N",  "County Size Code",
     16L,   "COUSUB",        37L,          5L,      "A/N",  "County Subdivision (FIPS)",
     17L, "COUSUBCC",        42L,          2L,      "A/N",  "FIPS County Subdivision Class Code",
     18L, "COUSUBSC",        44L,          2L,      "A/N",  "County Subdivision Size Code",
     19L,    "PLACE",        46L,          5L,      "A/N",  "Place (FIPS)",
     20L,  "PLACECC",        51L,          2L,      "A/N",  "FIPS Place Class Code",
     21L,  "PLACESC",        53L,          2L,      "A/N",  "Place Size Code",
     22L,    "TRACT",        55L,          6L,      "A/N",  "Census Tract",
     23L,   "BLKGRP",        61L,          1L,      "A/N",  "Block Group",
     24L,    "BLOCK",        62L,          4L,      "A/N",  "Block",
     25L,      "IUC",        66L,          2L,      "A/N",  "Internal Use Code",
     26L,   "CONCIT",        68L,          5L,      "A/N",  "Consolidated City (FIPS)",
     27L, "CONCITCC",        73L,          2L,      "A/N",  "FIPS Consolidated City Class Code",
     28L, "CONCITSC",        75L,          2L,      "A/N",  "Consolidated City Size Code",
     29L,   "AIANHH",        77L,          4L,      "A/N",  "American Indian Area/Alaska Native Area/Hawaiian Home Land (Census)",
     30L, "AIANHHFP",        81L,          5L,      "A/N",  "American Indian Area/Alaska Native Area/Hawaiian Home Land (FIPS)",
     31L, "AIANHHCC",        86L,          2L,      "A/N",  "FIPS American Indian Area/Alaska Native Area/Hawaiian Home Land Class Code",
     32L,  "AIHHTLI",        88L,          1L,      "A/N",  "American Indian Trust Land/Hawaiian Home Land Indicator",
     33L,   "AITSCE",        89L,          3L,      "A/N",  "American Indian Tribal Subdivision (Census)",
     34L,     "AITS",        92L,          5L,      "A/N",  "American Indian Tribal Subdivision (FIPS)",
     35L,   "AITSCC",        97L,          2L,      "A/N",  "FIPS American Indian Tribal Subdivision Class Code",
     36L,   "TTRACT",        99L,          6L,      "A/N",  "Tribal Census Tract",
     37L,  "TBLKGRP",       105L,          1L,      "A/N",  "Tribal Block Group",
     38L,     "ANRC",       106L,          5L,      "A/N",  "Alaska Native Regional Corporation (FIPS)",
     39L,   "ANRCCC",       111L,          2L,      "A/N",  "FIPS Alaska Native Regional Corporation Class Code",
     40L,     "CBSA",       113L,          5L,      "A/N",  "Metropolitan Statistical Area/Micropolitan Statistical Area",
     41L,   "CBSASC",       118L,          2L,      "A/N",  "Metropolitan Statistical Area/Micropolitan Statistical Area Size Code",
     42L,   "METDIV",       120L,          5L,      "A/N",  "Metropolitan Division",
     43L,      "CSA",       125L,          3L,      "A/N",  "Combined Statistical Area",
     44L,    "NECTA",       128L,          5L,      "A/N",  "New England City and Town Area",
     45L,  "NECTASC",       133L,          2L,      "A/N",  "New England City and Town Area Size Code",
     46L, "NECTADIV",       135L,          5L,      "A/N",  "New England City and Town Area Division",
     47L,   "CNECTA",       140L,          3L,      "A/N",  "Combined New England City and Town Area",
     48L,  "CBSAPCI",       143L,          1L,      "A/N",  "Metropolitan Statistical Area/Micropolitan Statistical Area Principal City Indicator",
     49L, "NECTAPCI",       144L,          1L,      "A/N",  "New England City and Town Area Principal City Indicator",
     50L,       "UA",       145L,          5L,      "A/N",  "Urban Area",
     51L,     "UASC",       150L,          2L,      "A/N",  "Urban Area Size Code",
     52L,   "UATYPE",       152L,          1L,      "A/N",  "Urban Area Type",
     53L,       "UR",       153L,          1L,      "A/N",  "Urban/Rural",
     54L,       "CD",       154L,          2L,      "A/N",  "Congressional District (111th)",
     55L,     "SLDU",       156L,          3L,      "A/N",  "State Legislative District (Upper Chamber) (Year 1)",
     56L,     "SLDL",       159L,          3L,      "A/N",  "State Legislative District (Lower Chamber) (Year 1)",
     57L,      "VTD",       162L,          6L,      "A/N",  "Voting District",
     58L,     "VTDI",       168L,          1L,      "A/N",  "Voting District Indicator",
     59L, "RESERVE2",       169L,          3L,      "A/N",  "Reserved",
     60L,    "ZCTA5",       172L,          5L,      "A/N",  "ZIP Code Tabulation Area (5-Digit)",
     61L,   "SUBMCD",       177L,          5L,      "A/N",  "Subminor Civil Division (FIPS)",
     62L, "SUBMCDCC",       182L,          2L,      "A/N",  "FIPS Subminor Civil Division Class Code",
     63L,    "SDELM",       184L,          5L,      "A/N",  "School District (Elementary)",
     64L,    "SDSEC",       189L,          5L,      "A/N",  "School District (Secondary)",
     65L,    "SDUNI",       194L,          5L,      "A/N",  "School District (Unified)",
     66L, "AREALAND",       199L,         14L,        "N",  "Area (Land)",
     67L, "AREAWATR",       213L,         14L,        "N",  "Area (Water)",
     68L,     "NAME",       227L,         90L,      "A/N",  "Area Name-Legal/Statistical Area Description (LSAD) Term-Part Indicator",
     69L, "FUNCSTAT",       317L,          1L,      "A/N",  "Functional Status Code",
     70L,    "GCUNI",       318L,          1L,      "A/N",  "Geographic Change User Note Indicator",
     71L,   "POP100",       319L,          9L,        "N",  "Population Count (100%)",
     72L,    "HU100",       328L,          9L,        "N",  "Housing Unit Count (100%)",
     73L, "INTPTLAT",       337L,         11L,      "A/N",  "Internal Point (Latitude)",
     74L, "INTPTLON",       348L,         12L,      "A/N",  "Internal Point (Longitude)",
     75L,    "LSADC",       360L,          2L,      "A/N",  "Legal/Statistical Area Description Code",
     76L, "PARTFLAG",       362L,          1L,      "A/N",  "Part Flag",
     77L, "RESERVE3",       363L,          6L,      "A/N",  "Reserved",
     78L,      "UGA",       369L,          5L,      "A/N",  "Urban Growth Area",
     79L,  "STATENS",       374L,          8L,      "A/N",  "State (ANSI)",
     80L, "COUNTYNS",       382L,          8L,      "A/N",  "County (ANSI)",
     81L, "COUSUBNS",       390L,          8L,      "A/N",  "County Subdivision (ANSI)",
     82L,  "PLACENS",       398L,          8L,      "A/N",  "Place (ANSI)",
     83L, "CONCITNS",       406L,          8L,      "A/N",  "Consolidated City (ANSI)",
     84L, "AIANHHNS",       414L,          8L,      "A/N",  "American Indian Area/Alaska Native Area/Hawaiian Home Land (ANSI)",
     85L,   "AITSNS",       422L,          8L,      "A/N",  "American Indian Tribal Subdivision (ANSI)",
     86L,   "ANRCNS",       430L,          8L,      "A/N",  "Alaska Native Regional Corporation (ANSI)",
     87L, "SUBMCDNS",       438L,          8L,      "A/N",  "Subminor Civil Division (ANSI)",
     88L,    "CD113",       446L,          2L,      "A/N",  "Congressional District (113th)",
     89L,    "CD114",       448L,          2L,      "A/N",  "Congressional District (114th)",
     90L,    "CD115",       450L,          2L,      "A/N",  "Congressional District (115th)",
     91L,    "SLDU2",       452L,          3L,      "A/N",  "State Legislative District (Upper Chamber) (Year 2)",
     92L,    "SLDU3",       455L,          3L,      "A/N",  "State Legislative District (Upper Chamber) (Year 3)",
     93L,    "SLDU4",       458L,          3L,      "A/N",  "State Legislative District (Upper Chamber) (Year 4)",
     94L,    "SLDL2",       461L,          3L,      "A/N",  "State Legislative District (Lower Chamber) (Year 2)",
     95L,    "SLDL3",       464L,          3L,      "A/N",  "State Legislative District (Lower Chamber) (Year 3)",
     96L,    "SLDL4",       467L,          3L,      "A/N",  "State Legislative District (Lower Chamber) (Year 4)",
     97L, "AIANHHSC",       470L,          2L,      "A/N",  "American Indian Area/Alaska Native Area/Hawaiian Home Land Size Code",
     98L,    "CSASC",       472L,          2L,      "A/N",  "Combined Statistical Area Size Code",
     99L, "CNECTASC",       474L,          2L,      "A/N",  "Combined NECTA Size Code",
    100L,     "MEMI",       476L,          1L,      "A/N",  "Metropolitan/Micropolitan Indicator",
    101L,    "NMEMI",       477L,          1L,      "A/N",  "NECTA Metropolitan/Micropolitan Indicator",
    102L,     "PUMA",       478L,          5L,      "A/N",  "Public Use Microdata Area",
    103L, "RESERVED",       483L,         18L,      "A/N",  "Reserved"
)
